...
class Personagem{
     ...
     * @return referencia a um objeto.
     */
    public Personagem clone(){  
 
       return new Personagem (this.nome, this.altura, this.peso, this.corCabelo, 
                              this.corPele, this.corOlhos, this.anoNascimento,
