/**
  ...
  *
  * TP02 - Questao 06 - Fila Circular em C
  *  
...
void inserirFila(char *s);
Personagem removerFila();
void mostrarFila();
float calcMedia();
...
// ------------------------------------------------------------- Metodos Fila de Personagem

// ------------------------------------ Insercao/Remocao

/**
 * Insere personagem na Fila Circular
 * @param s - Personagem a inserir
 */
void inserirFila(char* s){
...
float calcMedia(){    
   ...
   for (int i = primeiro ; i != ultimo ; i = ((i + 1) % (MAXTAM+1))){
      media = media + fila[i].altura;
   }
...
void mostrarFila(){
   ...
   for (int i = primeiro ; i != ultimo ; i = ((i + 1) % (MAXTAM+1))){
      ...
      printf(" ## %d", fila[i].altura);
      printf(" ## %g", fila[i].peso);
      printf(" ## %s", fila[i].corCabelo);
      printf(" ## %s", fila[i].corPele);
      printf(" ## %s", fila[i].corOlhos);
      printf(" ## %s", fila[i].anoNascimento);
      printf(" ## %s", fila[i].genero);
      printf(" ## %s", fila[i].homeworld);
      printf(" ## \n");
